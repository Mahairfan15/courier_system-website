...
<body>
    ...
    <div class="sidebar">
            <div class="text-center mb-3">
                ...
                <h2 style="font-weight: bold;">Agent Panel</h2>
            </div>
        <a href="agent_dashboard.php?page=home" >Dashboard</a>
        <a href="agent_dashboard.php?page=update">Update Status</a>
        <a href="agent_dashboard.php?page=track">Track Courier</a>
        <a href="logout.php">Logout</a>
    </div>

    <!-- Topbar -->
    <div class="topbar">
        <h2><span><strong>Dashboard</strong> - Courier Agent</span></h2>
        <h4><i><span>Welcome Agent</span></i></h4>
    </div>
    ...
    <div class="content">
        ...
        if (isset($_GET['page'])) {
            ...
            if ($page == 'update') {
                ...
                <div class="container-fluid">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <h2 class="fw-bold mb-0">Agent Dashboard Overview</h2>
                    </div>
            ...
            header("Location: agent_dashboard.php?page=home");
        }
        ?>
    </div>
</body>
